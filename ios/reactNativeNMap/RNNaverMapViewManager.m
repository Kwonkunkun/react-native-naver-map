...
RCT_EXPORT_METHOD(animateToZoom:(nonnull NSNumber *)reactTag
...
RCT_EXPORT_METHOD(animateToCoordinateWithZoomTo:(nonnull NSNumber *)reactTag
                  withCoord: (NMGLatLng *) coord
                  withZoom: (double) zoom
                  )
{
